...
public class BASEClass {
	...
	public void setup(String os,String br) throws IOException 
	{
		//Load properties file 
				FileReader file =new FileReader("D:\\SBE_SOFTWARE\\ParaBank\\src\\test\\resources\\config.properties");
				p=new Properties();
				p.load(file);
	...
	public String captureScreen(String tname) 
	{
		...
		String path="D:\\SBE_SOFTWARE\\ParaBank\\ScreenShots\\"+tname+" "+timeStamp+".png";
